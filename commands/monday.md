...
1. Read plan/PLAN.md; stop and suggest /nine-engines:setup if missing.
2. Read plan/review.md if present; last week's verdicts roll forward.
3. Write plan/monday.md per the template in skills/nine-engines/
