...
Rep-led, tiered outbound across phone, LinkedIn, email, and video. The
tiering decides how much personalization an account earns. Earns its cost
above a $25K ACV; below that, let engines 01 and 02 carry it.
...
(parallel dialing) · HubSpot (CRM)

## Run it when

ACV at $25K or above with rep coverage. A no-phone constraint degrades it
to email and LinkedIn only; it works at reduced power rather than dying.

## The full program

This engine has a complete operating manual: tiers, touch patterns, the
weekly plan, quota gates, and the stack, at
https://www.wesbecher.llc/pipeline. The repo does not duplicate it; the
site is the deep dive, this file is the portfolio card.

## First 90 days

Weeks 1 to 4: tier the list. Buy verified mobile data before buying
training. Set the touch pattern per tier.
