...
1. Read plan/monday.md and ask the user for the Friday numbers it named
   (batch the questions, one line per engine).
2. Append this week's review block to the TOP of plan/review.md per the
...
4. If verdict-level assumptions changed (budget, team, ACV), suggest
